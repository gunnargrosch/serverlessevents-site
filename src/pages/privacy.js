    ...
    <div id="main" className="alt">
      <section id="one">
        <div className="inner">
          ...
          <h4>Effective date: April 29, 2020</h4>
          <p>
            Serverless Events ("us", "we", or "our") operates the
            serverlessevents.io website (hereinafter referred to as the
          ...
          <h4>Service</h4>
          <p>
            Service is the <a href="https://serverlessevents.io">https://serverlessevents.io</a> website operated by Serverless Events
          </p>
          <h4>Personal Data</h4>
          <p>
          ...
          <h3>Use of Data</h3>
          <p>Serverless Events uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            If you are from the European Economic Area (EEA), the Serverless Events
          ...
          <p>Serverless Events may process your Personal Data because:</p>
          <ul>
          ...
          <p>
            Serverless Events will retain your Personal Data only for as long as is
          ...
          <p>
            Serverless Events will also retain Usage Data for internal analysis
            purposes. Usage Data is generally retained for a shorter period of
            time, except when this data is used to strengthen the security or to
            improve the functionality of our Service, or we are legally
            obligated to retain this data for longer periods. Transfer of Data
          </p>
          <p>
          ...
          <p>
            Serverless Events will take all the steps reasonably necessary to
          ...
          <p>
            Serverless Events may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Serverless Events
            </li>
            <li>
          ...
          <p>
            ...
            certain data protection rights. Serverless Events aims to take
          ...
          <p>
            ...
            your consent at any time where Serverless Events relied on your consent
          ...
          <p>
            By email: <a href="mailto:hello@Serverless Events.io">hello@Serverless Events.io</a>
          </p>
        </div>
      </section>
    </div>
